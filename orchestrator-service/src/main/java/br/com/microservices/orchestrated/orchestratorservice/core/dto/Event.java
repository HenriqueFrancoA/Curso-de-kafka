...
public class Event {
    ...
    public Event(String id, String transactionId, String orderId, Order payload, EEventSource source, ESagaStatus status, List<History> eventHistory, LocalDateTime createdAt) {
        this.id = id;
